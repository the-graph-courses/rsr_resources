...
Ans: The z-score is approximately -2.71, which means this baby's weight is about 2.71 standard deviations *below* the population mean. This is quite far from the average.

![A z-score measures how many standard deviations a value lies from the mean. Here 2.1 kg sits about 2.7 SDs into the left tail.](images/02_zscore.svg)
...
![Repeatedly draw a sample, record its mean, and collect those means into their own distribution.](images/03_sampling_distribution.svg)
...
flint_large <- tibble(weight_kg = c(3.0, 3.3, 2.8, 3.7, 3.2, 3.2, 3.3, 2.7,
                                    3.1, 3.5, 2.5, 3.2, 3.0, 3.3, 3.4, 3.0,
                                    3.9, 3.1, 3.0, 3.2, 3.3, 2.8, 3.1, 2.8,
...
![As the sample size grows, the sampling distribution of the mean gets narrower and taller around the population mean.](images/04_clt_narrowing.svg)
...
Ans: The mathematically calculated p-value (around 0.02) is very close to the proportion we found in our simulation (around 2% to 3%), showing that the mathematical formulas approximate the true behavior of repeated sampling.
...
Because it is small (about 0.02), a sample mean this low would be quite unlikely under chance alone, which is evidence that this group of babies really is lighter than the national average.
